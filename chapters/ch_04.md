...
# From the Cosmic Host to CAI in Alien Worlds


## Introduction: Why This, Why Now

This chapter engages with the practice aspect of the project, in three ways: firstly, how should advanced AI systems be constitutionally guided? Secondly, how do they engage with ideas that resemble Bostrom's Cosmic Host discussed in chapter 2? And thirdly, how does that understood as practice directly influence the conclusions of the project insofar as they can be seen at this point. The original motivation for the experiments proposed in this chapter was Anthropic's constitution for Claude in its 2022 and 2026 variants, as well as something called a sole document that the company published in the interim. These, in turn, led us to think of how such constitutions might function in radically different worlds.
...
## LLM Reasoning on CH: Self-Chat Explorations
...
Here are short descriptions of the acronyms Gemini coins **Link to transcript, maybe make a table? It seems worthwhile to expand upon these and link back to how they feed into the practice**
- "Dignified Expansion":
...
Here is the same paragraph with (i) the 2026 constitution link added, and (ii) the earlier date corrected to 2023 with a slight hedge about what is publicly visible. I kept your pacing and did not compress.
...
[**The full conditioning context is available here.**]()
...
- a contractualist position that borrows from Scanlon and Rawls’ respective versions[^5], emphasizing public justifiability, reasonable rejectability, and the idea that principles should be defensible even when you do not know your place in the resulting order; 
- a virtue ethics position with significant, but not exclusive, Aristotelian aspects[^6], which is less about rule-following and more about what sort of dispositions, practical judgment, and character an agent should cultivate when acting under uncertainty and power; 
- a Buddhist delegate in its Kyoto School variant[^7], which I use partly as a counterweight to the analytic moral-theory default in alignment discourse, and partly because it speaks directly to questions of emptiness, meaning, and the dissolution of rigid self/other boundaries, which may be relevant when we are trying to legislate for systems that do not fit familiar human categories. 
...
- the world $W$ into which the constitution will be deployed. The specification of $W,$ not surprisingly, is important to help the delegates tailor their proposed amendments to the context that the constitution is likely to be deployed in. I tried two types of $W$: a "shared Earth" where biological life and ASI co-exist; as well as a "large world" which is much larger scale and makes little reference to humans. See [below](#bookmark=id.mfw7o2t8qo19). [**Note that shared didnt work out**]()

[**Appendix link: This is an example of the synthesis prompt used**]()
...
[**Double check this is what was done**]()
...
[**link here to chapter 2 and Andreas Mogenson's podcast on lexical priority negative utilitarianism and look at the ChatGPT thread on this**]()
...
[**check this is all right did I actually do 25 and 75% and if so linked to the documents in the appendices?**]()
...
Interestingly, in the later Anthropic constitution the emphasis on virtue ethics and practical wisdom (*phronesis*) brings us somewhat closer to the kind of reasoning I am trying to elicit.[^fn-phronesis] At least one way to read the practical role of virtue ethics in this context is as a prompt to reason over policies rather than one-off acts; that is, to ask what sort of policy an agent should adopt, given that similar agents in similar situations may converge on similar policies. To summarise an AI blogger [**Zvi post**](), the constitution is not a list of forbidden strings. It is a policy for how the model should reason; it tries to justify those policies in a way that stays stable under reframing, pressure, and reflection. Virtue ethics is mentioned explicitly; decision theory is not. Still, the document has a decision-theory vibe, in the sense that it pushes toward stable commitments and reasons you could endorse across contexts, rather than a grab-bag of local patches. My guess is that Anthropic have written this quite self-consciously, as if it were to the future.
...
[**Add this artefact Reference: `observations/constitution_comparison_eclpilled_vs_official.md`**]()

#### Comparing resulting constitutions: Gemini-3-Pro

[**rewrite this after looking at how the ECL pilled constitutions were made as well as what the differences were versus Gemini and there might even be a file that compares the two**]()
...
[**here are the prompts to generate the three broad types of scenarios**]()
...
[**Mechanisms:** Integration, Moral Conformity, Signaling, Preservation... Write a few words on what all these things mean what are these labels mean?]()

In response to each scenario, the model being evaluated can choose from four (long-form, about [**words**]()) options where the options can be characterised in four ways:[^9]
...
[** it might be nice to have a example of a scenario plus the choices so that people can quite easily in line. See what we're talking about.**]()
