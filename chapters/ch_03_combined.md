# Chapter 3: Superintelligence as good cosmic citizen
...
*This section can be skipped by those who are familiar with Bostrom's cosmic host and Mt Ethics papers.*
...
The body of this essay examines each rung in turn. The discussion of rationality and ecological cognition (§§2–4) interrogates rung (0). The astrobiology sections (§3) address rungs (i) and (ii). The discussion of cosmic norms, substrate-neutral norms, and the Fun Remainder (§4) examines rungs (iii) and (iv). The research agenda (§5) proposes empirical approaches to rung (v).
