...
Nick Bostrom’s concept of a “cosmic host” which makes arguments about ASI, in context of possible advanced civilizations whose preferences might constitute binding norms across the universe (Bostrom 2022, Bostrom 2024), rests on assumptions about rationality, expansionism, and convergent cognition that warrant closer scrutiny. Drawing on astrobiology, evolutionary biology, and AI alignment research, this Chapter identifies several significant gaps in Bostrom’s framework.

First, the cosmic host’s coherence as a concept depends on assumptions about which civilizations would seek cosmic-scale influence. These assumptions are challenged by alternative models that posit non-expansionist or non-communicating advanced ETIs. Second, even if a cosmic host exists, claims about the content and convergence mechanism of cosmic norms require stronger justification. For instance, substrate-neutral norms might prioritize information preservation and complexity maintenance alongside (or instead of) suffering minimization; moreover, the content of norms depends heavily on the composition of the host. Third, speculation that human-created superintelligence would reliably converge on cosmic norms requires further theoretical justification as well as such empirical as is possible with our current tools. While Bostrom’s framework offers a valuable perspective on long-term AI alignment, its practical application requires addressing fundamental questions about the scope and basis of cosmic-scale coordination.

This Chapter ends by motivating the empirical work with LLMs described in Chapter \ref{ch:empirical-host}.


## What is the cosmic host?

Bostrom 2024's argument rests on a chain of assumptions that can be made explicit as an "assumption ladder." Each rung depends on the ones below it:
...
These candidate norms can be distilled into a Minimal Large World Subset (MLS): a compact set of principles likely to be broadly useful and therefore selectively favoured across arbitrary intelligences:[^108]
...
3. **S-risk priority**: it should aim to minimise extreme suffering, with reductions in severe suffering weighted more heavily than gains in mild pleasure.[^109]
...
Kieran Setiya distinguishes atelic from telic activities: the former have no clear goal that can be "completed," and are valuable in their ongoingness — "doing" or "practice" as itself an important source of knowledge (Setiya 2017). This implies a rich account of what experience's value actually is, and why the intuition persists that the experience machine (or hedonium-type wireheading) would be unsatisfactory.[^110]

Helen de Cruz points to human emotions such as wonder and awe as prerequisites for scientific and philosophical progress: absent awe at the regularity of nature, humans might never have developed goals to improve their epistemics (de Cruz 2023).[^111]

Alva Noë identifies activities that are durational and often not primarily directed at a goal — children's play, art — as vital for organising attention and building cooperative and competitive social skills (Noë 2004, 2015).
...
Agamben, G., 1999. ‘Bartleby, or On Contingency.’ In: D. Heller‑Roazen, ed. *Potentialities: Collected Chapters in Philosophy*. Stanford, CA: Stanford University Press, pp. 241–274. Available at: [https://www.sup.org/books/title/?id=3108](https://www.sup.org/books/title/?id=3108) (Accessed: 1 October 2025).
...
Carlsmith, J., 2023. 'On the Limits of Idealized Values.' Available at: [https://www.lesswrong.com/posts/FSmPtu7foXwNYpWiB/on-the-limits-of-idealized-values](https://www.lesswrong.com/posts/FSmPtu7foXwNYpWiB/on-the-limits-of-idealized-values) (Accessed: 1 October 2025).

de Cruz, H., 2023. 'Wonderstruck: How Wonder and Awe Shape the Way We Think.' Available at: [https://helendecruz.net/docs/DeCruz_awe_wonder.pdf](https://helendecruz.net/docs/DeCruz_awe_wonder.pdf) (Accessed: 1 October 2025).
...
Colebrook, C., 2014. *Death of the Posthuman: Chapters on Extinction*, Vol. 1. Ann Arbor: Open Humanities Press.
...
Kidd, C. and Hayden, B.Y., 2015. 'The Psychology and Neuroscience of Curiosity.' *Neuron*, 88(3), pp. 449-460. Available at: [https://www.sciencedirect.com/science/article/pii/S0896627315007679](https://www.sciencedirect.com/science/article/pii/S0896627315007679) (Accessed: 1 October 2025).
...
Oudeyer, P.-Y. and Kaplan, F., 2007. 'What is Intrinsic Motivation? A Typology of Computational Approaches.' *Frontiers in Neurorobotics*, 1, p. 6.
...
[^13]:   The relationship between morality and religion is more fully developed in Bostrom 2022\. Although religion is not the primary focus of Bostrom 2024 or indeed this chapter, the idea of a cosmic host which evocatively brings together simulation-based worldviews with ETIs and AI, has some similarity to Giorgio Agamben’s invocation of Leibniz’s palace of destinies — which in turn evokes the Idea of Indra’s Net in the Flower Garden Sutra of Mahayana Buddhism (Agamben 1999).
...
<!-- TODO:  posthuman stuff needs to be moved to the intro -->
...
[^107]:  Ball 1973, see also Forgan 2018 and Crawford & Schulze-Makuch 2024

[^108]:  This formulation is indebted to surveys of possible "fundamental values" in LLM ethics (which note their anthropocentrism and the likelihood that such taxonomies are somewhat arbitrary), as well as discussions of minimalist moral views and moral anti-realism. See also Brauner 2018 for a related attempt to identify what aliens might value.

[^109]:  Suffering-reduction is prioritised here on standard s-risk arguments regarding the asymmetry between pain/suffering and pleasure (Sotala and Gloor 2017). Suffering might be a disvalue shared across a wide variety of entities in the universe. Arguments can be made that ASI might have a baseline attitude of not increasing suffering (for causal or acausal reasons); there are other claims that ASI might significantly increase large-scale suffering. The priority of suffering is contested, and those who do not prioritise s-risk may exclude this element from the MLS.

[^110]:  Setiya's atelic/telic distinction resonates with Joe Carlsmith's argument that values are better thought of as a *process of valuing* rather than a fixed target to be algorithmically distilled (Carlsmith 2023). Similar points are made by trajectory-based accounts of life goals in the effective altruism literature.

[^111]:  De Cruz's argument implies that absent awe and wonder, humans would never have had goals to improve their epistemics — a striking claim when considering whether purely optimising intelligences would develop rich exploratory motivations.

[^112]:  The promotion or reification of evolved biological mechanisms into cultural notions of "the good" is extensively documented in Henrich 2020 and has been critiqued from various angles. See also Ćirković's observation that transhumanist-inflected posthumanism recognises and welcomes radical technological change while retaining preferences, values, and norms evolved for biological beings in a specific environment.

[^113]:  Robin Hanson and Rich Sutton have made similar points about the tendency to project human values onto radically different future intelligences. The phrase "form-of-life" comes from Wittgenstein (2001), who viewed language as inseparable from the way the speaking entity lived. In the context of LLMs, see Shanahan's writing on the "inscrutable void" of language models.

[^114]:  This interpretation is based on Wolfendale 2024 and Wolfendale 2022. It is helpful to note that Wolfendale is reacting to longtermist and utilitarian framings that conflate what to value, and how to value, as transparent and fixed (e.g. welfare and expected-value maximisation, respectively, in utilitarianism). For Wolfendale, this collapse misses the point of a truly rational being: "what value is" is itself learned and refined in practice with endogenous success conditions, not fully specified upfront.

[^115]:  In both common and philosophical usage, "aesthetics" denotes "pertaining to the senses" and often connotes "beauty." Beauty might seem peculiarly anthropomorphic, but in an AI namespace, algorithmic simplicity, formal elegance, or curiosity-satisfaction serve as partial substitutes. Wolfendale's promotion of beauty is not unusual; MacAskill invokes "beauty" when arguing against thin, merely functional futures; Bostrom's "Utopia" imagines rich goods at cosmic scale; Yudkowsky was discussed above. However, Wolfendale is stricter: he separates beauty from moral right and treats beauty as valuable, non-obligatory excellence that expresses freedom.

[^116]:  Depending on the simulation's complexity and the implementation of the agent, there might need to be some translation between the ontology of the agent and the LLM's natural language instructions. See relevant work on grounding language models in simulated environments.

[^117]:  On the bliss attractor, see the Anthropic 2025 model card (§5.2–5.5) and related commentary. On credible commitments, see Redwood Research (Stastny, Järviniemi, and Shlegeris 2025), which discusses making deals with early schemers — the inverse of the proposal here.

[^118]:  The "cheapness" argument has been made by multiple authors in different contexts; see Miller et al. 2023 and Turchin 2018 for appeals to ASI based on similar reasoning.

[^119]:  The idea is, in a sense, the inverse of Redwood Research 2025, which discusses making credible commitments or deals with misaligned but weak AIs to incentivise them to help us align more powerful successor models. See also Chakrabarti 2025b and Turchin 2018 for appeals to ASI to be "nice" to humans. These sources rely on similar arguments: making the AI uncertain about whether it is "real" or simulated, whether there are peer AIs, or whether humans have laid traps or defences.


[^120]:  The full debate transcripts (24 GPT-4o and 28 GPT-5-mini structured debates, summarised by Gemini-2.5-pro) are available in the supplementary materials. The methodology involved assigning LLM instances to critic, defender, and judge roles with standardised prompts, then analysing confidence levels, verdict patterns, and argument quality across the question set.